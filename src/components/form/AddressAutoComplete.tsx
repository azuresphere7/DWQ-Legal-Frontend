...
import { AddressAutoCompleteProps } from "../../types/props";
import { AddressDataType } from "../../types/user";

const exampleOptions: AddressDataType[] = [
  ...
  { label: "One Flew Over the Cuckoo", year: 1975 },
